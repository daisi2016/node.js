...
function getLodop(basePath,oOBJECT,oEMBED){
/**************************
...
**************************/
		//alert('getLodop....');
        var strHtml1="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='"+basePath+"/themes/default/js/install_lodop.exe'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
        var strHtml2="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='"+basePath+"/themes/default/js/install_lodop.exe'>执行升级</a>,升级后请重新进入。</font>";
	...
	try{		     
	     ...
	     //*****如下空白位置适合调用统一功能:*********	     
	     LODOP.SET_LICENSES("胜科金仕达数据系统(中国)有限公司","454607263797388864895795399998","",""); 
